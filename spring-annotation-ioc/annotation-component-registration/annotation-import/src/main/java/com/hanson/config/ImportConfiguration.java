...
import com.hanson.processor.CustomizeBeanDefinitionRegistryPostProcessor;
import com.hanson.registrar.CustomizeImportBeanDefinitionRegistrar;
import com.hanson.selector.CustomizeImportSelector;
 ...
 * -- 3.2)、使用ImportSelector接口,该接口返回 需要导入的 组件全类名数组(交给容器注册) 示例程序 {@link CustomizeImportSelector}
 * -- 3.3)、使用ImportBeanDefinitionRegistrar注册组件(手工注册) 示例程序 {@link CustomizeImportBeanDefinitionRegistrar}
 ...
 */
@Configuration
@Import({Color.class, CustomizeImportSelector.class, CustomizeImportBeanDefinitionRegistrar.class})
